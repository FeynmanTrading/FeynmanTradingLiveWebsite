...
gender_vote = 0.4868*male_parties_percentage + 0.5132*female_parties_percentage

income_vote = 0.0322*first_income_party_percentages + 0.2281*second_income_party_percentages + 0.2347*third_income_party_percentages + 0.2139*fourth_income_party_percentages +0.1001*fifth_income_party_percentages+0.1027*sixth_income_party_percentages+0.0453*seventh_income_party_percentages+0.043*eighth_income_party_percentages

income_vote

immigration_vote = 0.1755*not_bornin_canada_parties_percentage + 0.8245*bornin_canada_parties_percentage

province_vote = .1157*alberta_party_percentages + 0.1322*british_columbia_party_percentages + .0364*manitoba_party_percentages +0.0213*new_brunswick_party_percentages+0.0148*newfoundland_and_labrador_party_percentages+0.0012*northwest_territories_party_percentages+0.0263*nova_scotia_party_percentages+0.001*nanuvat_party_percentages+0.3826*ontario_party_percentages+0.0041*prince_edward_island_party_percentages+0.2323*quebec_party_percentages+0.0312*saskatchewan_party_percentages+0.001*yukon_party_percentages

marital_vote = 0.6275*married_party_percentages+ 0.3725*unmarried_party_percentages

parental_status = 0.6032*children_parties_percentage + 0.3968*no_children_parties_percentage

sexual_preference_vote = 0.984*heterosexual_parties_percentage + 0.016*homosexual_parties_percentage

household_vote = 0.1142*one_member_party_percentages + 0.2781*two_members_party_percentages + 0.1847*three_members_party_percentages + 0.2239*four_members_party_percentages+0.2102*five_members_party_percentages

mandatory_estimate= 1/8*gender_vote  +  1/8*income_vote  +  1/8*immigration_vote  +  1/8*province_vote  +  1/8*marital_vote  +  1/8*parental_status  +  1/8*sexual_preference_vote  +  1/8*household_vote 
mandatory_estimate
